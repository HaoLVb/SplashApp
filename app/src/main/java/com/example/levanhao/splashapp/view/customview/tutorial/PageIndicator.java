...
public class PageIndicator extends View {
    ...
    private Pager pager;
    private OnPageChangeListener scrollListener = new C29461();

    class C29461 implements OnPageChangeListener {
        C29461() {
        }
    ...
    private final void initPaints() {
        ...
        this.highLightDotPaint.setColor(getContext().getResources().getColor(R.color.red));
        this.highLightDotPaint.setStyle(Paint.Style.FILL_AND_STROKE);
