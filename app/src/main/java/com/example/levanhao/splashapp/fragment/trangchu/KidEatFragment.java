...
public class KidEatFragment extends Fragment implements OnClickViewListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        kidEatHandler = new KidEatHandler();
        LoginActivity.systemManager.getHandlerManager().setKidEatHandler(kidEatHandler);
    }

    public static KidEatFragment newInstance(int param) {
        KidEatFragment fragment = new KidEatFragment();
...
//        this.girdRecyclerView.setItemAnimator(new DefaultItemAnimator());
    ...
    private KidEatHandler kidEatHandler;
    ...
    public void onClickView(int type, ProductItem productItem) {
        ...
        switch (type) {
        case 1:
            LoginActivity.requestManager.likeProduct(MainActivity.token, productItem.getId(), kidEatHandler);
            LoginActivity.systemManager.getHandlerManager().sendMessage(
                    LoginActivity.systemManager.getHandlerManager().getMainHandler(),
    ...
    private class KidEatHandler extends Handler {
        @Override
