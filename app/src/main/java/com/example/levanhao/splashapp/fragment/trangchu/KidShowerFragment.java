...
public class KidShowerFragment extends Fragment implements OnClickViewListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        kidShowerHandler = new KidShowerHandler();
        LoginActivity.systemManager.getHandlerManager().setKidShowerHandler(kidShowerHandler);
    }

    public static KidShowerFragment newInstance() {
        return new KidShowerFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_kid_shower, container, false);
...
//        this.girdRecyclerView.setItemAnimator(new DefaultItemAnimator());
    ...
    private KidShowerHandler kidShowerHandler;
    ...
    private void refreshGird() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("category_id", String.valueOf(StaticVarriable.BE_TAM));
                return params;
            }
        };
    ...
    private class KidShowerHandler extends Handler {
        @Override
    ...
    public void onClickView(int type, ProductItem productItem) {
        ...
        switch (type) {
        case 1:
            LoginActivity.requestManager.likeProduct(MainActivity.token, productItem.getId(), kidShowerHandler);
            LoginActivity.systemManager.getHandlerManager().sendMessage(
                    LoginActivity.systemManager.getHandlerManager().getMainHandler(),
