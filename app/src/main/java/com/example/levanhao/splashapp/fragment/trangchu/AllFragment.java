 ...
 */
public class AllFragment extends Fragment implements OnClickViewListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        allFragmentHandler = new AllFragmentHandler();

        LoginActivity.systemManager.getHandlerManager().setAllFragmentHandler(allFragmentHandler);
    }
...
//        LoginActivity.requestManager.getListProduct(INDEX, COUNT, token, allFragmentHandler);
...
//                girdRecyclerView.setRefreshing(true);
//            }
//        });
        refreshList();
        refreshGird();
    ...
    private AllFragmentHandler allFragmentHandler;
    ...
    public void onClickView(int type, ProductItem productItem) {
        ...
        switch (type) {
        case 1:
            LoginActivity.requestManager.likeProduct(MainActivity.token, productItem.getId(), allFragmentHandler);
            LoginActivity.systemManager.getHandlerManager().sendMessage(
                    LoginActivity.systemManager.getHandlerManager().getMainHandler(),
    ...
    private class AllFragmentHandler extends Handler {
        @Override
