...
public class KidSleepFragment extends Fragment implements OnClickViewListener {
    private LoadMoreFooterView loadMoreListFooterView;
    private LoadMoreFooterView loadMoreGirdFooterView;
    //    public boolean isLoadMore;
    RequestQueue requestQueue;

    public KidSleepFragment() {
        // Required empty public constructor
    }

    public static KidSleepFragment newInstance() {
        KidSleepFragment fragment = new KidSleepFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        kidSleepHandler = new KidSleepHandler();
        LoginActivity.systemManager.getHandlerManager().setKidSleepHandler(kidSleepHandler);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_kid_sleep, container, false);
...
//        this.girdRecyclerView.setItemAnimator(new DefaultItemAnimator());
    ...
    private KidSleepHandler kidSleepHandler;
    ...
    private void refreshGird() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("category_id", String.valueOf(StaticVarriable.BE_NGU));
                return params;
            }
        };
    ...
    private class KidSleepHandler extends Handler {
        @Override
    ...
    public void onClickView(int type, ProductItem productItem) {
        ...
        switch (type) {
        case 1:
            LoginActivity.requestManager.likeProduct(MainActivity.token, productItem.getId(), kidSleepHandler);
            LoginActivity.systemManager.getHandlerManager().sendMessage(
                    LoginActivity.systemManager.getHandlerManager().getMainHandler(),
